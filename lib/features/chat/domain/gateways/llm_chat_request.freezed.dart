...
as bool?,webSearchEnabled: freezed == webSearchEnabled ? _self.webSearchEnabled : webSearchEnabled // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Model model,  List<LlmMessage> messages,  String? system,  double? temperature,  int? maxTokens,  double? topP,  int? topK,  double? frequencyPenalty,  double? presencePenalty,  int? seed,  List<String>? stopSequences,  String? responseFormat,  bool? parallelToolCalls,  bool? logprobs,  String? user,  String? reasoningEffort,  int? thinkingBudget,  bool? includeThoughts,  bool? cacheControl,  bool? webSearchEnabled,  bool? codeExecutionEnabled,  bool? useSearchGrounding,  String? safetyLevel,  Map<String, dynamic>? customParameters,  bool stream,  bool useResponsesAPI,  List<McpToolDefinition>? tools,  Map<String, String>? extraHeaders,  Map<String, dynamic>? extraBody)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LlmChatRequest() when $default != null:
return $default(_that.model,_that.messages,_that.system,_that.temperature,_that.maxTokens,_that.topP,_that.topK,_that.frequencyPenalty,_that.presencePenalty,_that.seed,_that.stopSequences,_that.responseFormat,_that.parallelToolCalls,_that.logprobs,_that.user,_that.reasoningEffort,_that.thinkingBudget,_that.includeThoughts,_that.cacheControl,_that.webSearchEnabled,_that.codeExecutionEnabled,_that.useSearchGrounding,_that.safetyLevel,_that.customParameters,_that.stream,_that.useResponsesAPI,_that.tools,_that.extraHeaders,_that.extraBody);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Model model,  List<LlmMessage> messages,  String? system,  double? temperature,  int? maxTokens,  double? topP,  int? topK,  double? frequencyPenalty,  double? presencePenalty,  int? seed,  List<String>? stopSequences,  String? responseFormat,  bool? parallelToolCalls,  bool? logprobs,  String? user,  String? reasoningEffort,  int? thinkingBudget,  bool? includeThoughts,  bool? cacheControl,  bool? webSearchEnabled,  bool? codeExecutionEnabled,  bool? useSearchGrounding,  String? safetyLevel,  Map<String, dynamic>? customParameters,  bool stream,  bool useResponsesAPI,  List<McpToolDefinition>? tools,  Map<String, String>? extraHeaders,  Map<String, dynamic>? extraBody)  $default,) {final _that = this;
switch (_that) {
case _LlmChatRequest():
return $default(_that.model,_that.messages,_that.system,_that.temperature,_that.maxTokens,_that.topP,_that.topK,_that.frequencyPenalty,_that.presencePenalty,_that.seed,_that.stopSequences,_that.responseFormat,_that.parallelToolCalls,_that.logprobs,_that.user,_that.reasoningEffort,_that.thinkingBudget,_that.includeThoughts,_that.cacheControl,_that.webSearchEnabled,_that.codeExecutionEnabled,_that.useSearchGrounding,_that.safetyLevel,_that.customParameters,_that.stream,_that.useResponsesAPI,_that.tools,_that.extraHeaders,_that.extraBody);case _:
  throw StateError('Unexpected subclass');
