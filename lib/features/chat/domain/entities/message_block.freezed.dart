...
mixin _$MessageBlock {
 ...
 String get id; String get messageId; MessageBlockStatus get status;@IsoDateTimeConverter() DateTime get createdAt;@IsoDateTimeConverter() DateTime? get updatedAt; Model? get model; Map<String, dynamic>? get metadata; Map<String, dynamic>? get error;
...
@useResult
$Res call({
 String id, String messageId, MessageBlockStatus status,@IsoDateTimeConverter() DateTime createdAt,@IsoDateTimeConverter() DateTime? updatedAt, Model? model, Map<String, dynamic>? metadata, Map<String, dynamic>? error
});
...
/// Create a copy of MessageBlock
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? messageId = null,Object? status = null,Object? createdAt = null,Object? updatedAt = freezed,Object? model = freezed,Object? metadata = freezed,Object? error = freezed,}) {
...
class KnowledgeReferenceBlock implements MessageBlock {
  const KnowledgeReferenceBlock({required this.id, required this.messageId, required this.status, @IsoDateTimeConverter() required this.createdAt, @IsoDateTimeConverter() this.updatedAt, this.model, final  Map<String, dynamic>? metadata, final  Map<String, dynamic>? error, required this.content, required this.knowledgeBaseId, this.source, this.similarity, final  String? $type}): _metadata = metadata,_error = error,$type = $type ?? 'knowledge_reference';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,messageId,status,createdAt,updatedAt,model,const DeepCollectionEquality().hash(_metadata),const DeepCollectionEquality().hash(_error),content,knowledgeBaseId,source,similarity);
...
@override @useResult
$Res call({
 String id, String messageId, MessageBlockStatus status,@IsoDateTimeConverter() DateTime createdAt,@IsoDateTimeConverter() DateTime? updatedAt, Model? model, Map<String, dynamic>? metadata, Map<String, dynamic>? error, String content, String knowledgeBaseId, String? source, double? similarity
});
